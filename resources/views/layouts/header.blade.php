<header class=" top-0 left-0 right-0 z-20 bg-gray-900 px-5 py-4 flex items-center justify-between w-full shadow-xl dark:shadow dark:shadow-slate-800">
    <a class="font-sans-russo text-xl text-gray-200" href="/" aria-label="Логотип сайта">
    ...
    <nav class="flex items-center gap-4">
        <ul class="flex items-center gap-2 px-1 rounded bg-gray-800">
            <li>
                <a class="flex items-center justify-center bg-gray-800 p-2 fill-gray-400 hover:fill-gray-200" href="https://github.com/Den4ik117" target="_blank" aria-label="Ссылка на GitHub аккаунт Дениса">
            ...
            <li>
                <a class="flex items-center justify-center bg-gray-800 p-2 fill-gray-400 hover:fill-gray-200" href="https://t.me/denchik1170" target="_blank" aria-label="Ссылка на телеграм Дениса">
            ...
            <li>
                <a class="flex items-center justify-center bg-gray-800 p-2 fill-gray-400 hover:fill-gray-200" href="https://vk.com/public216979635" target="_blank" aria-label="Ссылка на группу в ВКонтакте Дениса">
        ...
        <button id="mode-switcher" class="flex items-center justify-center rounded bg-gray-800 hover:bg-gray-700 stroke-gray-400 hover:stroke-gray-200 p-2" aria-label="Сменить тему">
