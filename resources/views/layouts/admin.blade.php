      ...
      <nav class="menu py-2">
        <ul class="flex flex-col gap-1">
          @auth
            ...
            <li><a class="block px-3 py-2 rounded-md font-medium hover:bg-gray-100 @if(Route::is('admin.orders.*')) underline @endif" href="{{ route('admin.orders.index') }}">Покупки</a></li>
