...
<head>
    ...
    <meta property="og:url" content="https://deniszagvozdin.ru/articles">
    <meta property="og:site_name" content="Создание сайтов под ключ от Full-stack разбработчика Дениса Загвоздина">
    <meta property="og:image" content="https://deniszagvozdin.ru/images/og-image-blog.jpg">
...
<body class="antialiased font-sans-manrope text-gray-600 dark:text-gray-200 font-medium bg-gray-100 dark:bg-[#0B1120] h-full">
    <header class=" top-0 left-0 right-0 z-20 bg-gray-900 px-5 py-4 flex items-center justify-between w-full shadow-xl dark:shadow dark:shadow-slate-800">
        <a class="font-sans-russo text-xl text-gray-200" href="/">
                    ...
                    <div class="flex flex-col gap-6">
                        @foreach($chunk as $article)
                            <a class="shadow hover:shadow-lg dark:shadow-slate-700" href="{{ route('articles.show', $article->slug) }}">
                                <img class="w-full" src="{{ Vite::image('Background_2.jpg') }}" alt="Background_2.jpg">
